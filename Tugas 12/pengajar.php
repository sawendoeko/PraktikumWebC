  ...
  <div class="kanan">
    ...
    <div class="isi">
            ...
            <div class="pengajar">
                ...
                <div class="container">
                    <h3>NAMA </h3>
                    <p style="font-size: 17px;">Natzu</p>
                    <h3>NIDN</h3>
                    <p style="font-size: 17px;">678912345</p>
                </div>
            </div>
            <div class="pengajar">
                <img src="./image/pengajar.jpg" alt="profil1" style="width:200px">
                <div class="container">
                    <h3>NAMA </h3>
                    <p style="font-size: 17px;">Lucy</p>
                    <h3>NIDN</h3>
                    <p style="font-size: 17px;">987654321</p>
                </div>
            </div>
            <div class="pengajar">
                <img src="./image/pengajar.jpg" alt="profil1" style="width:200px">
                <div class="container">
                    <h3>NAMA </h3>
                    <p style="font-size: 17px;">Grey</p>
                    <h3>NIDN</h3>
                    <p style="font-size: 17px;">456712389</p>
                </div>
            </div>
        </div>
  </div>
